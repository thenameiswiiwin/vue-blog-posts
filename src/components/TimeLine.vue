...
<template>
  <div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="px-4 py-5 sm:px-6 shadow-lg rounded-lg">
      <div>
        <div class="sm:hidden">
          ...
          <select
            id="periods"
            name="periods"
            class="block w-full rounded-md border-gray-300 focus:border-green-500 focus:ring-green-500 cursor-pointer"
            @change="onChange"
          >
